...
export class TripController {
    ...
    create = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.tripRepository.createTrip(tripData);
    ...
    getAll = async (req: Request, res: Response) => {
        try {
            const result = await this.tripRepository.getAllTrip();
            return res.status(200).json(result);
        } catch (error: any) {
            console.error('Error fetching trips:', error);
            return res.status(500).json({ error: 'Failed to fetch all trips', details: error.message });
        }
    }
    ...
    getByName = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.tripRepository.getTripByName(name);
            return res.status(200).json(result);
        } catch (error: any) {
            console.error('Error fetching trip by name:', error);
            return res.status(500).json({ error: 'Failed to fetch trip by name', details: error.message });
        }
    }
    ...
    update = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.tripRepository.updateTrip(id, tripData);
            return res.status(201).json(result);
        } catch (error: any) {
    ...
    delete = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.tripRepository.deleteTrip(id);
            return res.status(200).json(result);
        } catch (error: any){
